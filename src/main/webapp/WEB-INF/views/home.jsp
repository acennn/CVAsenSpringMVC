            ...
            <tr class="experience_article" >
              <th>
                <article class="job">
                  ...
                  <div class="text_align_center" > Organizing and managing surveying crew, working with different software SBG.GEO, Leica,Topcon, LandDesktop and CivilDesign etc., creating digital 3D models.
                  <br/>
                  <br/>
                  </div>
                </article>
            ...
            <tr class="experience_article" >
              <th>
                <article class="job">
                  ...
                  <div class="text_align_center" > Organizing and managing surveying crew, working with different software Leica,Topcon, LandDesktop and CivilDesign etc., creating digital 3D models.
                  <br/>
                  <br/>
                  </div>
                </article>
            ...
            <tr class="experience_article" >
              <th>
                <article class="job">
                  ...
                  <div class="text_align_center" > Working with different software SBG.GEO, Leica,Topcon, LandDesktop and CivilDesign etc., creating digital 3D models.
                  <br/>
                  <br/>
                  </div>
                </article>
            ...
            <tr class="experience_article" >
              <th>
                <article class="job">
                  ...
                  <div class="text_align_center" > Working with different software Leica,Topcon, LandDesktop and CivilDesign etc., creating digital 3D models.
                  <br/>
                  <br/>
                  </div>
                </article>
